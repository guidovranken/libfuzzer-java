...
public class MethodTransformer extends MethodVisitor {
	...
	private void instrumentLocation() {
		...
		mv.visitMethodInsn(INVOKESTATIC, "edu/cmu/sv/kelinci/Mem", "updateIntensity", "()V", false);
		//mv.visitMethodInsn(INVOKESTATIC, "edu/cmu/sv/kelinci/Mem", "updateHeapUsage", "()V", false);
	}
